...
$query = "select * from ordernow where restaurant = '". $field7name ."'";
if( $result = $mysqli->query($query)) {
while($row = $result->fetch_assoc()) {
$field1name = $row["dishname"];
...
<a href="'.$field13name.'" class="product-photo">
                
<img src="'.$field13name.'" height="100" />
...
<p class="product-make"><b>'.$field2name.'</b> '.$field3name.'</p>
<p  class="product-cost"><b>Price: </b>'.$field4name.'</p>
<br>              

<p class="user-make"><b>Username: </b>'.$field5name.'</p>                
