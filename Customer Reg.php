...
$choice = stripslashes($_REQUEST['choice']);
...
$phonenumber = $_REQUEST['phonenumber'];
        ...
        $query = "INSERT into `register` (`name`, `password`, `choice`, `email`, `phone number`)
VALUES ('$name', '".md5($password)."','$choice' ,'$email', '$phonenumber')";
...
Customer Name<input type="text" placeholder=" Enter your Name" name="name" required/>
